...
export class TreatmentController {
  ...
  @ApiOperation({
    summary:
      'Get or create patient profile with allergies and underlying diseases',
  })
  ...
  @ApiOperation({
    summary:
      'Get all lookup data (treatment types, disease groups, hospitals, etc.)',
  })
  async getLookups() {
  ...
  @ApiOperation({
    summary: 'Create or update patient allergy (sp_PP_02_UpsertPatientAllergy)',
  })
  ...
  @ApiOperation({
    summary: 'Soft-delete patient allergy (requires patient_id query param)',
  })
  ...
  @ApiOperation({
    summary:
      'Create or update underlying disease (sp_PP_03_UpsertUnderlyingDisease)',
  })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: 'Soft-delete underlying disease (requires patient_id query param)',
  })
  @ApiParam({ name: 'id', type: Number })
  @ApiQuery({ name: 'patient_id', required: true, type: Number })
  async deleteDisease(
  ...
  @Get('external-people')
  @ApiOperation({
    summary: 'Search external people by name / national ID / company',
  })
    ...
    schema: {
      ...
      properties: {
        ...
        vitals_json: {
          type: 'string',
          example:
            '{"bp_systolic":120,"bp_diastolic":80,"pulse":72,"temp_c":37.0,"spo2":98}',
        },
  ...
  @Get('visits')
  @ApiOperation({
    summary: 'Get visit list with filters (sp_TR_02_GetVisitList)',
  })
  ...
  @Get('visits/:id')
  @ApiOperation({
    summary: 'Get visit detail + usages (sp_TR_03_GetVisitById)',
  })
  @ApiParam({ name: 'id', type: Number })
  ...
  @ApiOperation({
    summary: 'Get last approved physical stock count date (sp_TR_05)',
  })
  ...
  @Put('visits/:visitId')
  @ApiOperation({
    summary: 'Update visit header + usages (sp_TR_06_UpdateVisit)',
  })
  ...
  async updateVisit(
    ...
    return this.treatmentService.updateVisit(
      Number(visitId),
      body,
      this.currentUser,
    );
  ...
  @ApiOperation({
    summary: 'Soft-delete a visit and reverse stock (sp_TR_07_DeleteVisit)',
  })
  @ApiParam({ name: 'visitId', type: Number })
  ...
  @ApiOperation({
    summary: 'Update medicine quantity in a visit (sp_TR_04_UpdateVisitUsage)',
  })
  @ApiParam({ name: 'id', type: Number })
  ...
  async updateVisitUsage(
    ...
    return this.treatmentService.updateVisitUsage(
      Number(usageId),
      body,
      this.currentUser,
    );
