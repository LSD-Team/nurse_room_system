...
export type IUpdateSupplierBody = ICreateSupplierBody;
...
export interface ICreateTreatmentTypeBody {
  treatment_code: string;
  treatment_name_th: string;
...
export type IUpdateTreatmentTypeBody = ICreateTreatmentTypeBody;
...
export interface ICreateReferTypeBody {
  refer_code: string;
  refer_name_th: string;
...
export type IUpdateReferTypeBody = ICreateReferTypeBody;
...
export interface ICreateDiseaseGroupBody {
  group_code: string;
  group_name_th: string;
...
export type IUpdateDiseaseGroupBody = ICreateDiseaseGroupBody;
...
export interface ICreateDiseaseTypeBody {
  group_id: number;
  sub_group_code: string;
  sub_group_name_th: string;
...
export type IUpdateDiseaseTypeBody = ICreateDiseaseTypeBody;
...
export interface ICreateHospitalBody {
  hospital_code: string;
  hospital_name_th: string;
...
export type IUpdateHospitalBody = ICreateHospitalBody;
...
export interface ICreateUnitBody {
  unit_code: string;
  unit_name_th?: string;
  unit_name_en?: string;
}

export type IUpdateUnitBody = ICreateUnitBody;
...
export type IUpdateItemBody = ICreateItemBody;
