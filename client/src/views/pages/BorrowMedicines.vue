            ...
            >
              <template #value="{ placeholder }">
                <span v-if="selectedItemInfo">
                  {{ selectedItemInfo.item_name_th }} ({{ selectedItemInfo.item_name_en }}) - ฿{{
      ...
      <div v-if="detailBorrow" class="flex flex-col gap-4">
        <div class="grid grid-cols-2 gap-4">
          ...
          <div v-if="detailBorrow.approval_role">
            ...
            <span class="ml-2"
              >{{ detailBorrow.approval_role }} (L{{ detailBorrow.approval_level }})</span
            >
          </div>
              ...
              <div class="mb-3">
                <div class="flex items-center gap-2 mb-1">
                  <Tag
                    ...
                    :style="{ backgroundColor: logActionColor(item.action), color: '#fff' }"
                  />
                  <span
                    v-if="item.approval_role !== 'SUBMITTER'"
                    class="text-sm text-surface-500"
                    >{{ item.approval_role }}</span
                  >
                </div>
                <div class="text-sm">
