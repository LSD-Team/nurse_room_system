...
import { CustomerService } from '@/services/mock/CustomerService';
...
import type { Product, ProductOrder } from '@/services/mock/ProductService';
            ...
            <template #header>
                <div class="flex justify-between">
                    ...
                    <IconField>
                        ...
                        <InputText v-model="(filters1.global as DataTableFilterMetaData).value" placeholder="Keyword Search" />
                    </IconField>
                </div>
            </template>
