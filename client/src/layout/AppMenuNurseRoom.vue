...
const model = ref<MenuItem[]>([
    {
        ...
        items: [
            ...
            { label: 'เบิกยากรณีพิเศษ', icon: 'pi pi-fw pi-exclamation-triangle', color: 'text-yellow-400', to: '/special-medicine-request' },
            {
                ...
                color: 'text-rose-400',
                items: [
                    { label: 'การรักษาพยาบาล', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-treatment' },
                    { label: 'ประวัติการ Refer', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-refer' },
                    { label: 'ประวัติการเกิดอุบัติเหตุในงาน', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-accident' },
                    { label: 'ประวัติโรคที่คาดว่าเกิดจากการทำงาน', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-occupational-disease' },
                    { label: 'ประวัติเจ็บป่วยจากโรงพยาบาล', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-hospital-treatment' },
                    { label: 'ประวัติโรคเจ็บป่วยเรื้อรัง', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-chronic-disease' },
                    { label: 'ผลตรวจสุขภาพเข้างานใหม่', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-health-check-new' },
                    { label: 'ผลตรวจสุขภาพประจำปี E1+', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-health-check-annual' },
                    { label: 'ผลตรวจสุขภาพกรณีโยกย้ายงาน', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-health-check-transfer' },
                    { label: 'ผลตรวจมะเร็งปากมดลูก', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-cervical-cancer' },
                    { label: 'ข้อมูลพยาบาล', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-nurses' },
                    { label: 'จัดซื้อยา/เวชภัณฑ์', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-purchase' },
                    { label: 'ยืมยา/เวชภัณฑ์', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-borrow' },
                    { label: 'สต็อก ยา/เวชภัณฑ์ รายเดือน', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-stock-monthly' },
                    { label: 'การใช้ ยา/เวชภัณฑ์ รายวัน', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-usage-daily' },
                    { label: 'การรักษาพยาบาลรายโรค', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-treatment-by-disease' },
                    { label: 'สถานพยาบาลประกันสังคม', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-social-security' },
                    { label: 'ผลตรวจสุขภาพประจำปี OP-S4', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-health-check-ops4' },
                    { label: 'การเบิกยากรณีพิเศษ', icon: 'pi pi-fw pi-file', color: 'text-rose-300', to: '/report-special-medicine' }
                ]
            }
        ]
    }
