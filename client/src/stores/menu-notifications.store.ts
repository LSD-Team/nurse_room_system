...
export const useMenuNotificationsStore = defineStore(
  'menuNotifications',
  () => {
    ...
    async function refreshBorrowPendingCount() {
      borrowPendingCount.value =
        await MenuNotificationsService.getBorrowPendingCount();
      borrow.value = borrowPendingCount.value;
    }

    async function refreshApprovalPendingCount() {
      approvalPendingCount.value =
        await MenuNotificationsService.getApprovalPendingCount();
